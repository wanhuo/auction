...
use \Workerman\Config\Redis as Config;
use Exception;
...
class MyRedis {
    ...
    public function __construct() {
        ...
        if(!$this->redis){
            throw new Exception('查看redis的host和port');
        }
        //设置前缀 一般为APP名称
    ...
    {
        return $this->redis->sRem($key, $member1, $member2, $memberN); // TODO: Change the autogenerated stub
    }
