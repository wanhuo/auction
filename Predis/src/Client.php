...
class Client implements ClientInterface
{
    ...
    public function __construct($parameters = null, $options = null)
    {
        ...
        $this->connection = $this->createConnection(isset(RConfig::$config['dsn'])?
                RConfig::$config['dsn']:($parameters ?: array()));

        $this->profile = $this->options->profile;
        $this->select(isset(RConfig::$config['db'])?RConfig::$config['db']:0);
